...
import BlogImage1 from "../assets/Images/BlogImages/BlogImage1.jpg";
import BlogImage2 from "../assets/Images/BlogImages/BlogImage2.jpg";
import BlogImage3 from "../assets/Images/BlogImages/BlogImage3.jpg";
import BlogImage4 from "../assets/Images/BlogImages/BlogImage4.jpg";
import BlogImage5 from "../assets/Images/BlogImages/BlogImage5.jpg";
import BlogImage6 from "../assets/Images/BlogImages/BlogImage6.jpg";
import BlogImage7 from "../assets/Images/BlogImages/BlogImage7.jpg";
import BlogImage8 from "../assets/Images/BlogImages/BlogImage8.jpg";
import BlogImage9 from "../assets/Images/BlogImages/BlogImage9.jpg";
import BlogImage10 from "../assets/Images/BlogImages/BlogImage10.jpg";
import BlogImage11 from "../assets/Images/BlogImages/BlogImage11.jpg";
import BlogImage12 from "../assets/Images/BlogImages/BlogImage12.jpg";
import AuthorImage from "../assets/Images/BlogImages/AuthorImage.jpg";
        ...
        <div className="flex flex-col gap-6 px-4 w-full max-w-[771px] mx-auto mb-6">
          ...
          <div className="flex flex-row items-start justify-between shadow-lg bg-white rounded-lg space-x-4 mt-4 p-4">
            <div className="flex flex-col space-y-4">
              <img src={AuthorImage} className="w-20 h-20 rounded-full" />
          ...
          <div className="flex flex-row justify-between items-start w-full space-x-2">
            <img src={BlogImage10} className="rounded-lg w-15 h-15" />
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex flex-row justify-between items-start w-full space-x-2">
                <img src={BlogImage11} className="rounded-lg w-10 h-10" />
                <div className="flex flex-col space-y-2">
              ...
              <div className="flex flex-row justify-between items-start w-full space-x-2">
                <img src={BlogImage12} className="rounded-lg w-10 h-10" />
                <div className="flex flex-col space-y-2">
                  <h1 className="font-bold text-xl text-[#5c4efc]">
                    Desirae Geidt
                  </h1>
