...
const About = () => {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-white px-6 py-12">
      <h1 className="lg:text-4xl text-2xl font-bold lg:mb-8 mb-4">ABOUT OUR APP</h1>
      ...
      >
        <div className="absolute lg:left-16 lg:bottom-2 left-6 bottom-24 w-60 h-28 bg-white rounded-[50%_50%_50%_50%/60%_60%_40%_40%] shadow-lg z-0" />
        <img
          src={android}
          alt="Android"
          className="w-40 md:w-72 lg:w-96 h-auto relative z-10 mx-auto"
        />
        <div className="flex flex-col items-center justify-center lg:mt-0 lg:ml-40 ml-20 w-full max-w-xl">
