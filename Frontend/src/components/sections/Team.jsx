import teamMember1 from "../../assets/Images/Profile/Profile1.jpg";
import teamMember2 from "../../assets/Images/Profile/Profile2.jpg";
import teamMember3 from "../../assets/Images/Profile/Profile3.jpg";
import { Facebook, Instagram, Twitter, Youtube } from "lucide-react";

const Team = () => {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-white lg:py-20 lg:mt-12 md:py-30 md:mt-32 mt-48 p-6">
